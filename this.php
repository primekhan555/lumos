...
<nav class="navbar navbar-default navbar-fixed-top" style="">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
     <ul class="nav navbar-nav navbar nav-pills">         
      ...
      <div class="navbar-nav ml-auto" style="margin-top:13px; margin-left: 33%; ">
        <div class="dropdown">
          <button class="dropbtn"><?php echo "faisal@gmail.com"; ?></button>
