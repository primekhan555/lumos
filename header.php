    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand logo" href="index.html">
                ...
                <h3 style="font-size: 30;color: white; font-weight: bolder;">EdStart.</h3>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav header-ml">
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu dm-2" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="index.php">Index 01</a></li>
                        ...
                        <div class="dropdown-menu megamenu" aria-labelledby="dropdown01">
                            <div class="megamenu-area">
                                <div class="row sobuz">
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                        <div class="megamenu-section">
                                            <h6 class="megamenu-title">Contact us</h6>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item" >
                        <a href="employer-dashboard-post-job.html" style="background-color: #ffc440" class="nav-link link-color">
